...
#=========Search Train Window============
    ...
    def buildSearchTrainWindow(self,searchTrainWindow):
        ...
        departsFrom = OptionMenu(searchTrainWindow, departsFromDate, "New York", "Atlanta", "LA")
        departsFrom.grid(row=2,column=2)
        arrivesAtDate=StringVar(searchTrainWindow)
        arrivesAtDate.set("New York(Penn Station)")
        arrivesAt = OptionMenu(searchTrainWindow, arrivesAtDate, "Boston(BBY)", "Atlanta", "LA")
  ...
  #=========Select Departure Window============
    ...
    def selectDepartureBackButtonClicked(self):
        ...
        self.searchTrainWindow.deiconify()
 ...
 #=========Travel Extras and Passenger Window============
    ...
    def buildTravelExtrasPassengerInfoWindow(self,travelExtrasPassengerInfoWindow):
        ...
        numberOfBaggage = OptionMenu(travelExtrasPassengerInfoWindow, numberOfBaggage, "2", "3", "4")
