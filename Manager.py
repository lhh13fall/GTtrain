...
class Manager(object):
    ...
    def __init__(self, username):
        ...
        self.cursor.execute("SELECT email FROM Managerowner WHERE username = %s", self.username)
        self.email = self.cursor.fetchone()[0]
        # Manager's Menu
        self.ManagerMenuWindow = Tk()
        self.ManagerMenuWindow.title("Georgia Restaurant Health Inspections - Manager\'s Menu")
        ...
        self.buildManagerMenuWindow(self.ManagerMenuWindow)
        self.ManagerMenuWindow.mainloop()

#-----------------------------------BUTTON CLICKED METHODS------------------------------------

    def enterInfoButtonClicked(self):
        self.ManagerMenuWindow.withdraw()
    ...
    def exitSystemButtonClicked(self):
        self.ManagerMenuWindow.destroy()
...
#------------------------------------BUILD WINDOW METHODS------------------------------------------------
    ...
    def buildManagerMenuWindow(self, window):
    ...
    def buildDisplayReportWindow(self, window):
        # Back Button
        backButton = Button(window, text = "Back", command = self.backFromDisplayReportWindowToManagerMenu)
