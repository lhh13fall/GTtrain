...
#=========Search Train Window============
    ...
    def searchTrainWindowFindTrainsButtonClicked(self):
        ...
        if datetime.strptime(self.departureDate, '%Y-%m-%d').date() < datetime.today().date():
            # print(datetime.strptime(self.departureDate, '%Y-%m-%d').date())
            # print(datetime.today().date())
            messagebox.showwarning("Error", "Departure date is less than today")
            return False
 ...
 #=========Make Reservation Window============
    ...
    def buildMakeReservationWindow(self, makeReservationWindow):
        ...
        self.currentlySelectedTree.column("1", width = 150, anchor = "center")
        self.currentlySelectedTree.column("2", width = 150, anchor = "center")
        self.currentlySelectedTree.column("3", width = 150, anchor = "center")
        self.currentlySelectedTree.column("4", width = 150, anchor = "center")
        self.currentlySelectedTree.column("5", width = 150, anchor = "center")
        self.currentlySelectedTree.column("6", width = 150, anchor = "center")
        self.currentlySelectedTree.column("7", width = 150, anchor = "center")
        self.currentlySelectedTree.column("8", width = 150, anchor = "center")
        self.currentlySelectedTree.column("9", width = 150, anchor = "center")
        self.currentlySelectedTree.column("10", width = 150, anchor = "center")
        self.currentlySelectedTree.column("11", width = 150, anchor = "center")
